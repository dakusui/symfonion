...
A pattern is a sequence of strokes with associated default parameters; its relationships with strokes and notes are described in the
figure above.
...
The following is a complete example using a swing groove (`link:../../main/resources/examples/example-groove-swing.json[example-groove-swing.json]`).
...
[source, json]
----
include::../../main/resources/examples/example-groove-swing.json[]
----
...
The following complete example (`link:../../main/resources/examples/example-stacking-crescendo.json[example-stacking-crescendo.json]`) plays a C major arpeggio ascending with a crescendo (volume 20→110), then descending with a decrescendo (volume 110→20).
The melody and the volume sweep are two stacked entries on the same `piano` part.

[source, json]
----
include::../../main/resources/examples/example-stacking-crescendo.json[]
----

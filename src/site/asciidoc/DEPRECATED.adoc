...
NOTE: This feature is deprecated. The plan is to integrate `jq-front` into the symfonion use case instead. See https://github.com/dakusui/symfonion/issues/15[Issue-15] for details.

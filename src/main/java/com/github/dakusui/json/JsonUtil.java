...
public class JsonUtil {
  ...
  private static JsonElement asJsonElementWithDefault(JsonElement base,
      JsonElement defaultValue, int from, Object[] path)
      throws JsonPathNotFoundException, JsonInvalidPathException {
    JsonElement ret = _asJsonElement(base, defaultValue, from, path);
    // //
    // TODO: Workarounding test failure. Need to come up with more consistent
  ...
  private static JsonElement asJsonElement(JsonElement base, int from,
      Object[] path) throws JsonPathNotFoundException, JsonInvalidPathException {
  ...
  public static JsonObject asJsonObjectWithDefault(JsonObject base,
      ...
      throws JsonTypeMismatchException, JsonPathNotFoundException,
  ...
  public static JsonObject asJsonObject(JsonObject base, Object... path)
      throws JsonPathNotFoundException, JsonTypeMismatchException,
      JsonInvalidPathException {
  ...
  public static JsonArray asJsonArrayWithPromotion(JsonElement base,
      Object... path) throws JsonPathNotFoundException,
  ...
  public static JsonArray asJsonArrayWithDefault(JsonElement base,
      ...
      JsonPathNotFoundException, JsonInvalidPathException {
  ...
  public static int asIntWithDefault(JsonElement base, int defaultValue,
      ...
      JsonPathNotFoundException, JsonFormatException, JsonInvalidPathException {
    try {
      return Integer.parseInt(asStringWithDefault(base,
          Integer.toString(defaultValue), path));
    } catch (NumberFormatException e) {
      throw new JsonFormatException(asJsonElement(base, path));
    }
  }
  ...
  public static long asLongWithDefault(JsonElement base, long defaultValue,
      ...
      JsonPathNotFoundException, JsonFormatException, JsonInvalidPathException {
    try {
      return Long.parseLong(asStringWithDefault(base,
          Long.toString(defaultValue), path));
    } catch (NumberFormatException e) {
      throw new JsonFormatException(asJsonElement(base, path));
    }
  }
  ...
  public static float asFloatWithDefault(JsonElement base, float defaultValue,
      ...
      JsonPathNotFoundException, JsonFormatException, JsonInvalidPathException {
    try {
      return Float.parseFloat(asStringWithDefault(base,
          Float.toString(defaultValue), path));
    } catch (NumberFormatException e) {
      throw new JsonFormatException(asJsonElement(base, path));
    }
  }
  ...
  public static double asDoubleWithDefault(JsonElement base,
      ...
      JsonPathNotFoundException, JsonFormatException, JsonInvalidPathException {
    try {
      return Double.parseDouble(asStringWithDefault(base,
          Double.toString(defaultValue), path));
    } catch (NumberFormatException e) {
      throw new JsonFormatException(asJsonElement(base, path));
    }
  }
  ...
  public static Iterator<String> keyIterator(final JsonObject json) {
    Iterator<String> i = new Iterator<String>() {
      Iterator<Entry<String, JsonElement>> iEntries = json.entrySet()
                                                        .iterator();
